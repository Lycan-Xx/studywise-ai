                    ...
                    <CardContent className="p-8">
                        ...
                        <div className="space-y-3">
                            {currentQuestion.options.map((option, index) => (
                                <div
                                    key={index}
                                    className={`border rounded-lg p-4 cursor-pointer transition-all ${answers[currentQuestion.id] === option
            ...
            {timeDisplay && (
                <div className="flex justify-center">
                    <div className="flex gap-4">
                        <div className={`text-center p-4 rounded-lg ${isTimeRunningOut ? 'bg-red-100' : 'bg-studywise-gray-100'
                            }`}>
                            <div className={`text-2xl font-bold ${isTimeRunningOut ? 'text-red-600' : 'text-studywise-gray-900'
                                }`}>
                                {timeDisplay.minutes}
                            </div>
