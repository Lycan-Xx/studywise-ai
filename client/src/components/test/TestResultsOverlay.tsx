                    ...
                    {insights.studyRecommendations && insights.studyRecommendations.length > 0 && (
                      <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                        ...
                        <ul className="text-purple-700 space-y-1">
                          {Array.isArray(insights.studyRecommendations) && insights.studyRecommendations.map((recommendation: string, index: number) => (
                    ...
                    {insights.focusAreas && insights.focusAreas.length > 0 && (
                      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                        ...
                        <ul className="text-yellow-700 space-y-1">
                          {Array.isArray(insights.focusAreas) && insights.focusAreas.map((area: string, index: number) => (
